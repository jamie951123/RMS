...
public class ReceivingItemDaoImpl implements ReceivingItemDao {
    ...
    public List<ReceivingItemModel> findReceivingItemByPartyId(String json) {
        ...
        String result = "";
        try {
            result = new HttpPostAsync().execute(ReceivingItemServePath.findReceivingItemByPartyId(),json).get();
    ...
    public List<ReceivingItemModel> saves(String json) {
        ...
        try{
            result = new HttpPostAsync().execute(ReceivingItemServePath.saves(),json).get();
        }catch (InterruptedException e) {
            e.printStackTrace();
        } catch (ExecutionException e) {
            e.printStackTrace();
