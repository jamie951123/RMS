package com.example.james.rms.operation.receiving_action;
...
public class ReceivingIncreaseAct extends AppCompatActivity implements View.OnClickListener,
        CommunicateInterface<ReceivingItemModel>, MyDatePicker.MyDatePickerService,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_receiving_increase);
...
//                expandableSelectModel.setCount_dialogBox(expandableSelectModel.getCount_dialogBox()+1);
    ...
    public void createDialogBox() {
        ...
        CommunicateInterface communicateInterface = receivingIncreaseDialog;
        Log.d("asd", "[ReceivingIncreaseAct]--[item_original] :" + item_original);
        Log.d("asd", "[ReceivingIncreaseAct]--[item_latest] :" + item_latest);

        communicateInterface.putOriginalProductModels(item_original, item_latest, expandableSelectModel);
        Toast.makeText(this, "ReceivingIncreaseAct", Toast.LENGTH_SHORT).show();
    }
...
//        ClassicDialog classicDialog = new ClassicDialog(this);
    ...
    public List<ReceivingItemModel> getReceivingItem(Date receivingDate, Date createDate) {
        ...
        try {
            ...
            Log.d("asd", "[ReceivingIncreaseAct]-[Save]-[Error] : ReceivingItemModel  is null ");
        }
    ...
    public ReceivingOrderModel getReceivingOrder(int itemSize, Date receivingDate, Date createDate, String orderRemark) {
        ...
        Log.d("asd", "[ReceivingIncreaseAct]-[Save]-[Error] : ReceivingOrderModel is null ");
        return null;
    }
...
//                    ClassicDialog classicDialog = new ClassicDialog(v.getContext());
    ...
    public void returnData(NumberDialogModel numberDialogModel) {
        ...
        Log.d("asd", "[ReceivingIncreaseAct]-[returnData]-[item_original] :" + item_original);
        Log.d("asd", "[ReceivingIncreaseAct]-[returnData]-[item_latest] :" + item_latest);
        Log.d("asd", "[ReceivingIncreaseAct]-[returnData]-[item_listview] :" + item_listview);
        if (listView != null) {
