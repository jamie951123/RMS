...
import com.example.james.rms.main.receiving.adapter.ReceivingOrderExpandListAdapter;
...
public class ReceivingOrderFrag extends MyBaseFragment implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener,SwipeRefreshLayout.OnRefreshListener,View.OnTouchListener {
    ...
    public boolean onQueryTextChange(String newText) {
        if(ObjectUtil.isNullEmpty(newText)){
            receivingOrderExpandListAdapter.filterByProductName("");
        }else {
            receivingOrderExpandListAdapter.filterByProductName(newText);
        }
        return true;
    }
