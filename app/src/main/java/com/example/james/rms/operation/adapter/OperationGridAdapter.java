...
public class OperationGridAdapter extends BaseAdapter {
    ...
    Context context;
    private List<OperationAct.GridComponent> gridComponent = new ArrayList<>();

    public OperationGridAdapter(Context context, List<OperationAct.GridComponent> gridComponent) {
