    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        viewHolder.delivery_item_linear_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Movement Record
                String movementRecord_str = CommonFactory.movementFactory_str(NavigationAct.class.getCanonicalName(), DeliveryIncreaseAct.class.getCanonicalName(),R.id.nav_stockOut);

                //
                Intent intent = new Intent();
                intent.setClass(getContext(), DeliveryIncreaseAct.class);
