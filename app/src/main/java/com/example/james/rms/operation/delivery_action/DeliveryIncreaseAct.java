package com.example.james.rms.operation.delivery_action;
...
public class DeliveryIncreaseAct extends AppCompatActivity implements View.OnClickListener,MyDatePicker.MyDatePickerService,
        CommunicateInterface<ReceivingOrderModel>,NumberDialogListener,Cloneable {
...
//        boolean isContinueOutter = true;
        ...
        Log.v("asd","DeliveryIncreaseAct-[order_original] :" + order_original);
    }
...
//            SetDeliveryOrder Field
    ...
    public void createDialogBox(){
        ...
        CommunicateInterface communicateInterface = deliveryIncreaseDialog;
        communicateInterface.putOriginalProductModels(order_original,null,expandableSelectedModel);
        Toast.makeText(this,"DeliveryIncreaseAct",Toast.LENGTH_SHORT).show();
    }
...
//        ClassicDialog classicDialog = new ClassicDialog(this);
    ...
    public void putLatestProductModel(List<ReceivingOrderModel> item_listview, ExpandableSelectedModel expandableSelectModel) {
        ...
        Log.v("asd","[DeliveryIncreaseAct]-[ListView_Status]-[List<ReceivingOrderModel>]-[item_listview] :" + item_listview);
        Log.v("asd","[DeliveryIncreaseAct]-[ListView_Status]-[ExpandableSelectedModel] :" + expandableSelectModel);
    ...
    public void returnData(NumberDialogModel numberDialogModel) {
        ...
        Log.d("asd","[NumberDialog]-->[DeliveryIncreaseAct]-[order_latest] :" + orginalMapByReceivingItemId);
    ...
    private void getitemOutStandingMapByReceivingItemId(){
        ...
        Log.d("asd","[DeliveryIncreaseAct]-[ItemOutStandingMap] :" + itemOutStandingMap);
    }
