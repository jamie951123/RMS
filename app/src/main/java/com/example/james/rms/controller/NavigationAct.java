...
import com.example.james.rms.common.fab_button.FabCore;
...
import com.example.james.rms.ui.login.LoginAct;
...
import com.example.james.rms.operation.OperationAct;
import com.example.james.rms.main.product_pool.ProductContainerFrag;
...
public class NavigationAct extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    private void setUpFragmentType(){
        fragments.add(new ReceivingFrag());
        fragments.add(new DeliveryContainerFrag());
        fragments.add(new InventoryContainerFrag());
        fragments.add(new ProductContainerFrag());
...
//        fab_menu.addMenuButton(fabReceiving);
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = intent.setClass(getApplication(), OperationAct.class);
                MovementRecord movementRecord = new MovementRecord();
                movementRecord.setOriginalClass_string(NavigationAct.class.getCanonicalName());
                movementRecord.setTargetClass_string(OperationAct.class.getCanonicalName());
    ...
    private int currentPageToCode(String className){
      ...
      if(className.equals(ProductContainerFrag.class.getCanonicalName())){
          page = R.id.nav_all_product;
      }else if(className.equals(ReceivingFrag.class.getCanonicalName())){
          page = R.id.nav_receiving;
      }else if(className.equals(InventoryContainerFrag.class.getCanonicalName())){
          page = R.id.nav_inventory;
      }else if(className.equals(DeliveryContainerFrag.class.getCanonicalName())){
...
//        super.onBackPressed();
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            switch (pager.getCurrentItem()){
                case 0:
                    navBackPressed = (ReceivingFrag)fragment;
                    isFirst = navBackPressed.changeCurrentPage();
                    break;
                case 1:
                    navBackPressed = (DeliveryContainerFrag)fragment;
                    isFirst = navBackPressed.changeCurrentPage();
                    break;
            }
            if(!isFirst){
