...
import com.example.james.rms.main.inventory.adapter.InventoryContainerAdapter;
...
public class InventoryContainerFrag extends MyBaseFragment implements ViewPagerListener{

    @BindView(R.id.inventory_container_pages)
    MyViewPager pager;
    private InventoryContainerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragments.add(new InventoryItemFrag());
        fragments.add(new InventoryItem2Frag());
        adapter = new InventoryContainerAdapter(getActivity().getSupportFragmentManager(),fragments);
...
//                Log.d("asd","[InventoryContainerFrag] --Nav -> InventoryContainerFrag -> InventoryItemFrag");
//                fragments.add(new InventoryItemFrag());
//                fragments.add(new InventoryItem2Frag());
