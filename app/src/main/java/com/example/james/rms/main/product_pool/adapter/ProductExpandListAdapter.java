...
//                .into(holder.productImage);
        ...
        holder.linear_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String movementRecord_str = CommonFactory.movementFactory_str(NavigationAct.class.getCanonicalName(), ReceivingIncreaseAct.class.getCanonicalName(),R.id.nav_all_product);
                ...
                intent.setClass(getContext(), ProductIncreaseAct.class);
